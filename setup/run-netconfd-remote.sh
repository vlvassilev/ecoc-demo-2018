...
#export HADMREG_INIT_ARG="verbose:ethernet:br0 0x1515 00:0A:35:03:43:37"
export HADMREG_INIT_ARG="verbose:netconf:ssh2:client 185.35.202.52 830 pi ecocdemo"
